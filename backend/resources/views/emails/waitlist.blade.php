    ...
    <tr>
      <td align="center" style="padding:40px 12px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Title -->
          <tr>
            <td align="center" style="padding:50px 32px 0 32px;">
          ...
          <tr>
            <td align="center" style="padding:30px 32px 0 32px;">
              <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:22px;color:#cfe6da;text-align:center;">
