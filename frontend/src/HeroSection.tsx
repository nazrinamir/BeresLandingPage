...
const HeroSection = () => {
  return (
    <section id="home" className="text-white w-full py-20 rounded-xl">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 gap-8">
        ...
        <div className="md:w-5/12 w-full mb-12 md:mb-0" data-aos="fade-right">
          ...
          {/* Email Input + Button */}
          <div className="flex items-center bg-white rounded-full overflow-hidden shadow w-full max-w-md">
            <input
              type="email"
