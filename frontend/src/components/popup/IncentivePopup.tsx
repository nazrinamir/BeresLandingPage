  ...
  <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
    <div className="relative flex flex-col items-center">
      ...
      <a
        ...
        className="absolute text-md md:text-base -bottom-4 md:-bottom-4 !bg-[#012219] !text-[#AFEB2B] font-bold px-6 py-4 md:px-8 md:py-4 rounded-full shadow-md hover:bg-lime-500 transition z-40"
      >
