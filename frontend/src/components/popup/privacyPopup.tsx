                    ...
                    <div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
                            <ul className="space-y-3 sm:space-y-4">
                                ...
                                <li className="border-b border-gray-100 pb-2 sm:pb-3 last:border-b-0 last:pb-0">
                                    <p className="text-gray-700 text-sm sm:text-base leading-relaxed"><strong className="text-gray-900">Website</strong> refers to <span className={`!text-[${BRAND_COLOR}] font-semibold`}>Beres</span>, are accessible from two links: Landing Page is  <a href="https://beres.com.my/" rel="external nofollow noopener" target="_blank" className="text-blue-600 hover:text-blue-800 underline break-all">https://beres.com.my/</a> and Main System is <a href="https://app.beres.com.my/" rel="external nofollow noopener" target="_blank" className="text-blue-600 hover:text-blue-800 underline break-all">https://app.beres.com.my/</a></p>
                                </li>
                                <li className="border-b border-gray-100 pb-2 sm:pb-3 last:border-b-0 last:pb-0">
