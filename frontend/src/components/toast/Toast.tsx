...
const Toast: React.FC<ToastProps> = ({ toast }) => {
    ...
    const getToastStyles = () => {
        // Glass-morphism base styles with blur background
        const baseStyles = "backdrop-blur-lg bg-opacity-20 border border-opacity-30 shadow-2xl rounded-2xl p-5 mb-3 max-w-sm min-w-[320px]";
    ...
    return (
        ...
        >
            <div className="flex items-center">
                ...
                <button
                    onClick={handleClose}
                    className="ml-4 flex-shrink-0 w-6 h-6 bg-white bg-opacity-20 !text-black hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
                >
                    X
                </button>
            </div>
