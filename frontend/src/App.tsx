          ...
          {isMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                <a href="#home" className="block px-3 py-2 text-gray-700 hover:text-blue-600" onClick={toggleMenu}>Home</a>
                <a href="#features" className="block px-3 py-2 text-gray-700 hover:text-blue-600" onClick={toggleMenu}>Features</a>
                <a href="#about" className="block px-3 py-2 text-gray-700 hover:text-blue-600" onClick={toggleMenu}>About</a>
                <a href="#contact" className="block px-3 py-2 text-gray-700 hover:text-blue-600" onClick={toggleMenu}>Contact</a>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-blue-600"> Beres</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Innovative solutions that help your business grow, scale, and succeed in today's digital world.
            </p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">hello@beres.com</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-6 h-6 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">123 Business Ave, Suite 100, City, State 12345</span>
                  </div>
                </div>
              </div>
